...
export default function CardSlider() {
  ...
  useEffect(() => {
    ...
    if (slider) {
      ...
      setTimeout(checkScrollBounds, 500);
    }
  ...
  return (
    <div className="relative w-full py-10">
      ...
      <div
        ref={sliderRef}
        className="w-full flex gap-5 overflow-x-auto scrollbar-none snap-x snap-mandatory pb-6"
        ...
        {offers.map((product) => {
          ...
          return (
            <motion.div
              ...
              className="group flex min-w-[340px] max-w-[380px] shrink-0 cursor-pointer snap-start items-stretch overflow-hidden rounded-3xl border border-[var(--color-border)] bg-[var(--color-card)] transition-colors hover:border-[var(--color-accent)]/50 hover:shadow-[0_16px_40px_-16px_var(--color-accent)] sm:min-w-[400px]"
            >
